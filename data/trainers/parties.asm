...
; Cerulean City
	db $FF, 18, SPEAROW, 15, RHYHORN, 15, RATTATA, 17, EEVEE, 0
...
LtSurgeData:
	db $FF, 28, RAICHU, 26, ELECTRODE, 26, ELECTABUZZ, 0

ErikaData:
	db $FF, 30, TANGELA, 32, VICTREEBEL, 32, VILEPLUME, 30, GLOOM, 0

KogaData:
	db $FF, 44, VENOMOTH, 46, GOLBAT, 48, WEEZING, 50, VENOMOTH, 50, MUK, 0

BlaineData:
	db $FF, 48, NINETALES, 50, RAPIDASH, 54, ARCANINE, 50, MAGMAR, 50, RHYDON, 0

SabrinaData:
	db $FF, 50, MR_MIME, 50, KADABRA, 50, ALAKAZAM, 50, VENOMOTH, 0
...
Rival2Data:
; SS Anne 2F
	db $FF, 19, SPEAROW, 16, SLOWPOKE, 18, RHYHORN, 20, EEVEE, 0
; Pokémon Tower 2F
	db $FF, 25, FEAROW, 23, SLOWPOKE, 22, GROWLITHE, 20, RHYHORN, 25, JOLTEON, 0
	db $FF, 25, FEAROW, 23, MAGNEMITE, 22, SHELLDER, 20, RHYHORN, 25, FLAREON, 0
	db $FF, 25, FEAROW, 23, GROWLITHE, 22, MAGNEMITE, 20, RHYHORN, 25, VAPOREON, 0
; Silph Co. 7F
	db $FF, 38, RHYDON, 35, ARCANINE, 37, GYARADOS, 35, KADABRA, 40, JOLTEON, 0
	db $FF, 38, RHYDON, 35, GYARADOS, 37, MAGNETON, 35, KADABRA, 40, FLAREON, 0
	db $FF, 38, RHYDON, 35, MAGNETON, 37, ARCANINE, 35, KADABRA, 40, VAPOREON, 0
; Route 22
	db $FF, 47, RHYDON, 45, EXEGGUTOR, 45, ARCANINE, 47, GYARADOS, 50, ALAKAZAM, 53, JOLTEON, 0
	db $FF, 47, RHYDON, 45, EXEGGUTOR, 45, GYARADOS, 47, MAGNETON, 50, ALAKAZAM, 53, FLAREON, 0
	db $FF, 47, RHYDON, 45, EXEGGUTOR, 45, MAGNETON, 47, NINETALES, 50, ALAKAZAM, 53, VAPOREON, 0

Rival3Data:
; Champion's Room
	db $FF, 61, RHYDON, 59, ALAKAZAM, 61, EXEGGUTOR, 61, GYARADOS, 63, ARCANINE, 65, JOLTEON, 0
	db $FF, 61, RHYDON, 59, ALAKAZAM, 61, EXEGGUTOR, 61, MAGNETON, 63, GYARADOS, 65, FLAREON, 0
	db $FF, 61, RHYDON, 59, ALAKAZAM, 61, EXEGGUTOR, 61, ARCANINE, 63, MAGNETON, 65, VAPOREON, 0
...
AgathaData:
	db $FF, 56, GENGAR, 56, GOLBAT, 55, HYPNO, 58, SNORLAX, 60, GENGAR, 0

LanceData:
	db $FF, 58, GYARADOS, 56, CHARIZARD, 56, DRAGONITE, 60, AERODACTYL, 62, DRAGONITE, 0
