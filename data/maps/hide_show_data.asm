...
Route4HS:
	db ROUTE_4, ROUTE4_TM_WATERFALL, SHOW
Route9HS:
...
Route15HS:
	db ROUTE_15, ROUTE15_TM_LIGHT_SCREEN, SHOW
Route16HS:
...
RocketHideoutB4FHS:
	...
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_TM_GROWTH, SHOW
...
SafariZoneEastHS:
	...
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_LEECH_LIFE,  SHOW
SafariZoneNorthHS:
...
CeruleanCave2FHS:
	...
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_HELIX_FOSSIL,   SHOW
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_MAX_REVIVE,   SHOW
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_DOME_FOSSIL, SHOW
CeruleanCaveB1FHS:
